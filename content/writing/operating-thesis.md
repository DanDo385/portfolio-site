...
slug: operating-thesis
date: 2026-01-01
status: draft
category: AI x Finance
excerpt: Two parallel financial systems are emerging. The highest-value work is designing the bridges between them.
coverImage: null
loomUrl: null
relatedProject: null
---
...
One urgent arena is **AI infrastructure finance**: compute financing, GPU-backed lending, datacenter debt, and tokenized credit. The other is just as important: using AI to rebuild financial infrastructure itself: research, underwriting, risk, settlement, reporting, and client workflows. Both are market-structure problems. Both need people who understand capital, code, and institutional constraints.

I position at this seam: deep enough in institutional finance to understand the real constraints, technical enough to design systems that actually work, and forward-leaning enough to see where AI, programmable assets, and market infrastructure reshape what is possible. **The highest-leverage role is translating between capital, code, and the markets that adopt both.**
