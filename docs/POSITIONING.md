...
truth for homepage copy, metadata, Experience section, Agent Mode, and resume-adjacent
surfaces. When copy drifts from this document, update the copy, not this document, unless
