          ...
          <div className="contact-grid">
            <Reveal className="contact-text">
              ...
              <div className="c-links">
                <a href="mailto:dan@magro.dev" className="c-link">
                  <div className="c-link-ico"><MailIcon /></div>
                  dan@magro.dev
                </a>
                <a href="https://github.com/DanDo385" className="c-link" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://twitter.com/DanQB13" className="c-link" target="_blank" rel="noopener noreferrer">
                  <div className="c-link-ico"><XIcon /></div>
                  @DanQB13
                </a>
              </div>
            </Reveal>
